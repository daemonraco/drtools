...
const manager_2 = require("../loaders/manager");
const manager_3 = require("../middlewares/manager");
const manager_4 = require("../routes/manager");
...
class ExpressConnector {
    ...
    attachLoaders(options, configs) {
        ...
        if (options.loadersDirectory) {
            ...
            manager = new manager_2.LoadersManager(options.loadersDirectory, options.loadersOptions, configs);
        }
        return manager;
    }
    attachMiddlewares(app, options, configs) {
        ...
        if (options.middlewaresDirectory) {
            ...
            manager = new manager_3.MiddlewaresManager(app, options.middlewaresDirectory, options.middlewaresOptions, configs);
        }
        return manager;
    }
    attachRoutes(app, options, configs) {
        ...
        if (options.routesDirectory) {
            ...
            manager = new manager_4.RoutesManager(app, options.routesDirectory, options.routesOptions, configs);
        }
        return manager;
    }
    //
