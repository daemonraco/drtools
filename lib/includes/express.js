...
class ExpressConnector {
    ...
    attachMiddlewares(app, options, configs) {
        ...
        if (options.middlewaresDirectory) {
            ...
            manager = new manager_2.MiddlewaresManager(app, options.middlewaresDirectory, options.middlewaresOptions, configs);
        }
        return manager;
    }
    attachRoutes(app, options, configs) {
        ...
        if (options.routesDirectory) {
            ...
            manager = new manager_3.RoutesManager(app, options.routesDirectory, options.routesOptions, configs);
        }
        return manager;
    }
    //
