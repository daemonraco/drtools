...
const endpoint_behaviors_1 = require("./endpoint-behaviors");
...
class EndpointData {
    ...
    constructor(dummyDataPath, options = {}) {
        ...
        this._behaviors = new endpoint_behaviors_1.EndpointBehaviors();
        this._options = {
            globalBehaviors: []
        };
        this._raw = '';
        this._options = tools_1.Tools.DeepMergeObjects(this._options, options);
        this.fixOptions();
